...
public:
	...
	F_INLINE bool GetMouseLeftButtonDown()
	{
		return B_CAST(mouse_input.rgbButtons[0]) && !B_CAST(mouse_input_preview.rgbButtons[0]);
	}
	F_INLINE bool GetMouseLeftButtonUp()
	{
		return !B_CAST(mouse_input.rgbButtons[0]) && B_CAST(mouse_input_preview.rgbButtons[0]);
	}
	F_INLINE bool GetMouseRightButtonDown()
	{
		return B_CAST(mouse_input.rgbButtons[1]) && !B_CAST(mouse_input_preview.rgbButtons[1]);
	}
	F_INLINE bool GetMouseRightButtonUp()
	{
		return !B_CAST(mouse_input.rgbButtons[1]) && B_CAST(mouse_input_preview.rgbButtons[1]);
	}
	F_INLINE bool GetMouseLeftButton()
	{
		return B_CAST(mouse_input.rgbButtons[0]);
	}
	F_INLINE bool GetMouseRightButton()
	{
		return B_CAST(mouse_input.rgbButtons[1]);
	}
